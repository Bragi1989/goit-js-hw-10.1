...
(0, _axiosDefault.default).defaults.headers.common["x-api-key"] = "live_oV6kwsCqQVuQJ1iOyl3IgPQ7tqy3GRldQQaEXehjgn3EctfIACfRB1n8lbnQseE9";
function fetchBreeds() {
    return (0, _axiosDefault.default).get("https://api.thecatapi.com/v1/breeds").then((response)=>response.data).catch((error)=>{
        console.error("\u041F\u043E\u043C\u0438\u043B\u043A\u0430 \u043F\u0440\u0438 \u0437\u0430\u0432\u0430\u043D\u0442\u0430\u0436\u0435\u043D\u043D\u0456 \u043F\u043E\u0440\u0456\u0434 \u043A\u043E\u0442\u0456\u0432:", error);
        throw error;
    });
}
function fetchCatByBreed(breedId) {
    return (0, _axiosDefault.default).get(`https://api.thecatapi.com/v1/images/search?breed_ids=${breedId}`).then((response)=>response.data[0]).catch((error)=>{
...
function handleBreedSelection() {
    ...
    const selectedBreedId = breedSelect1.value;
